...
<div class="container">
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
       <form action="../boardUpdate.do" method="post"><!-- @GetMapping("/boardUpdateForm.do/{idx}") 의 두번째 '/'가 경로로인식되어 'boardUpdate.do'로 전송하면-->
         <input type="hidden" name="idx" value="${vo.idx}"/><!--  //localhost:8081/controller/boardUpdateForm.do/boardUpdate.가 되어버리기때문에 ../ 이전단계이동경로를 줘야함 -->
