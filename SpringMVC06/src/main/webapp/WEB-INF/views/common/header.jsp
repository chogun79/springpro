...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <security:authorize access="isAnonymous()"><!-- 인증이되지 않은 사용자(입명사용자)인경우 아래 내용을 보여준다. -->
      ...
      <security:authorize access="isAuthenticated()"><!-- 인증이되된 사용자인 경우 아래 내용을 보여준다. -->
	      <ul class="nav navbar-nav navbar-right">
			    ...
			    <c:if test="${!empty mvo.member.memProfile}">
			     ...
			     (
			     <security:authorize access="hasRole('ROLE_USER')"> <!-- 시큐리티안에 권한정보만 확인하는 방법은 hasRole()사용 -->
			       U,
			     </security:authorize> 
